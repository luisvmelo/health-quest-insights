  ...
  return (
    <FormSection title="Nível de Atividade Física (IPAQ)">
      ...
      {physicalActivity && (
        <div className="space-y-6 p-4 bg-secondary/30 rounded-lg">
          ...
          <div className="space-y-3">
            <FormField
              control={form.control}
              name="moderateActivity.performs"
              render={({ field }) => (
                <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                  <FormControl>
                    <Checkbox
            ...
            {moderatePerforms && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 ml-6">
                <FormField
                  control={form.control}
                  name="moderateActivity.frequency"
                  render={({ field }) => (
                    <FormItem>
                ...
                <FormField
                  control={form.control}
                  name="moderateActivity.duration"
                  render={({ field }) => (
                    <FormItem>
          ...
          <div className="space-y-3">
            <FormField
              control={form.control}
              name="vigorousActivity.performs"
              render={({ field }) => (
                <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                  <FormControl>
                    <Checkbox
            ...
            {vigorousPerforms && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 ml-6">
                <FormField
                  control={form.control}
                  name="vigorousActivity.frequency"
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Quantas vezes na semana?</FormLabel>
                      <FormControl>
                ...
                <FormField
                  control={form.control}
                  name="vigorousActivity.duration"
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Tempo em minutos por sessão</FormLabel>
                      <FormControl>
          ...
          <div className="space-y-3">
            ...
            {lightWalkingPerforms && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 ml-6">
                <FormField
                  control={form.control}
                  name="lightWalking.frequency"
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Quantas vezes na semana?</FormLabel>
                      <FormControl>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <FormField
          control={form.control}
          name="sittingTimeWeekdays"
          render={({ field }) => (
            <FormItem>
              <FormLabel>Tempo sentado durante a semana (minutos/dia)</FormLabel>
              <FormControl>
                <Input
                  type="number"
                  placeholder="Ex: 480"
        ...
        <FormField
          control={form.control}
          name="sittingTimeWeekends"
          render={({ field }) => (
            <FormItem>
              <FormLabel>Tempo sentado durante o final de semana (minutos/dia)</FormLabel>
              <FormControl>
                <Input
                  type="number"
                  placeholder="Ex: 300"
